 ...
 */const x=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],m=l("check",x);/**
 * @license lucide-react v0.525.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const y=[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]],v=l("copy",y);/**
 * @license lucide-react v0.525.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const g=[["path",{d:"M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384",key:"9njp5v"}]],k=l("phone",g);function C({contactInfo:a}){const[r,n]=p.useState(null),c=[{icon:d,label:a.email,value:a.email,type:"copy"},{icon:k,label:a.phone,value:a.phone,type:"copy"},{icon:u,label:"LinkedIn",value:a.linkedin,type:"link"},{icon:h,label:"GitHub",value:a.github,type:"link"},{icon:f,label:a.location,value:null,type:"text"}],i=(e,o)=>{e.type==="copy"?(navigator.clipboard.writeText(e.value),n(o),setTimeout(()=>n(null),2e3)):e.type==="link"&&window.open(e.value,"_blank","noopener,noreferrer")};return t.jsx("div",{className:"flex flex-col gap-4 w-full",children:c.map((e,o)=>{const s=e.icon;return t.jsxs("button",{onClick:()=>i(e,o),className:`
