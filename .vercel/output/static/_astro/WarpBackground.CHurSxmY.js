...
in vec2 v_patternUV;`,H={fit:"none",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0},C={none:0,contain:1,cover:2},O=`
...
`,B={maxColorCount:10},G=`#version 300 es
precision mediump float;
...
`,N={checks:0,stripes:1,edge:2};function Y(t){if(Array.isArray(t))return t.length===4?t:t.length===3?[...t,1]:S;if(typeof t!="string")return S;let e,r,i,s=1;if(t.startsWith("#"))[e,r,i,s]=q(t);else if(t.startsWith("rgb"))[e,r,i,s]=k(t);else if(t.startsWith("hsl"))[e,r,i,s]=K(Z(t));else return console.error("Unsupported color format",t),S;return[_(e,0,1),_(r,0,1),_(i,0,1),_(s,0,1)]}function q(t){t=t.replace(/^#/,""),t.length===3&&(t=t.split("").map(o=>o+o).join("")),t.length===6&&(t=t+"ff");const e=parseInt(t.slice(0,2),16)/255,r=parseInt(t.slice(2,4),16)/255,i=parseInt(t.slice(4,6),16)/255,s=parseInt(t.slice(6,8),16)/255;return[e,r,i,s]}function k(t){const e=t.match(/^rgba?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([0-9.]+))?\s*\)$/i);return e?[parseInt(e[1]??"0")/255,parseInt(e[2]??"0")/255,parseInt(e[3]??"0")/255,e[4]===void 0?1:parseFloat(e[4])]:[0,0,0,1]}function Z(t){const e=t.match(/^hsla?\s*\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(?:,\s*([0-9.]+))?\s*\)$/i);return e?[parseInt(e[1]??"0"),parseInt(e[2]??"0"),parseInt(e[3]??"0"),e[4]===void 0?1:parseFloat(e[4])]:[0,0,0,1]}function K(t){const[e,r,i,s]=t,o=e/360,n=r/100,a=i/100;let f,u,l;if(r===0)f=u=l=a;else{const p=(v,x,d)=>(d<0&&(d+=1),d>1&&(d-=1),d<.16666666666666666?v+(x-v)*6*d:d<.5?x:d<.6666666666666666?v+(x-v)*(.6666666666666666-d)*6:v),g=a<.5?a*(1+n):a+n-a*n,h=2*a-g;f=p(h,g,o+1/3),u=p(h,g,o),l=p(h,g,o-1/3)}return[f,u,l,s]}const _=(t,e,r)=>Math.min(Math.max(t,e),r),S=[0,0,0,1];function J(t){const e=m.useRef(void 0),r=m.useCallback(i=>{const s=t.map(o=>{if(o!=null){if(typeof o=="function"){const n=o,a=n(i);return typeof a=="function"?a:()=>{n(null)}}return o.current=i,()=>{o.current=null}}});return()=>{s.forEach(o=>o?.())}},t);return m.useMemo(()=>t.every(i=>i==null)?null:i=>{e.current&&(e.current(),e.current=void 0),i!=null&&(e.current=r(i))},t)}async function w(t){const e={},r=[],i=o=>{try{return o.startsWith("/")||new URL(o),!0}catch{return!1}},s=o=>{try{return o.startsWith("/")?!1:new URL(o,window.location.origin).origin!==window.location.origin}catch{return!1}};return Object.entries(t).forEach(([o,n])=>{if(typeof n=="string"){if(!i(n)){console.warn(`Uniform "${o}" has invalid URL "${n}". Skipping image loading.`);return}const a=new Promise((f,u)=>{const l=new Image;s(n)&&(l.crossOrigin="anonymous"),l.onload=()=>{e[o]=l,f()},l.onerror=()=>{console.error(`Could not set uniforms. Failed to load image at ${n}`),u()},l.src=n});r.push(a)}else e[o]=n}),await Promise.all(r),e}const U=m.forwardRef(function({fragmentShader:e,uniforms:r,webGlContextAttributes:i,speed:s=0,frame:o=0,minPixelRatio:n,maxPixelCount:a,...f},u){const[l,p]=m.useState(!1),g=m.useRef(null),h=m.useRef(null);m.useEffect(()=>((async()=>{const d=await w(r);g.current&&!h.current&&(h.current=new V(g.current,e,d,i,s,o,n,a),p(!0))})(),()=>{h.current?.dispose(),h.current=null}),[e,i]),m.useEffect(()=>{(async()=>{const d=await w(r);h.current?.setUniforms(d)})()},[r,l]),m.useEffect(()=>{h.current?.setSpeed(s)},[s,l]),m.useEffect(()=>{h.current?.setMaxPixelCount(a)},[a,l]),m.useEffect(()=>{h.current?.setMinPixelRatio(n)},[n,l]),m.useEffect(()=>{h.current?.setFrame(o)},[o,l]);const v=J([g,u]);return R.jsx("div",{ref:v,...f})});U.displayName="ShaderMount";function Q(t,e){for(const r in t){if(r==="colors"){const i=Array.isArray(t.colors),s=Array.isArray(e.colors);if(!i||!s){if(Object.is(t.colors,e.colors)===!1)return!1;continue}if(t.colors?.length!==e.colors?.length||!t.colors?.every((o,n)=>o===e.colors?.[n]))return!1;continue}if(Object.is(t[r],e[r])===!1)return!1}return!0}const c={params:{...H,rotation:0,speed:1,frame:0,colors:["#262626","#2e383d","#64a5ce","#ffffff"],proportion:.45,softness:1,distortion:.25,swirl:.8,swirlIterations:10,shapeScale:.1,shape:"checks"}},ee=m.memo(function({speed:e=c.params.speed,frame:r=c.params.frame,colors:i=c.params.colors,proportion:s=c.params.proportion,softness:o=c.params.softness,distortion:n=c.params.distortion,swirl:a=c.params.swirl,swirlIterations:f=c.params.swirlIterations,shapeScale:u=c.params.shapeScale,shape:l=c.params.shape,fit:p=c.params.fit,scale:g=c.params.scale,rotation:h=c.params.rotation,originX:v=c.params.originX,originY:x=c.params.originY,offsetX:d=c.params.offsetX,offsetY:z=c.params.offsetY,worldWidth:y=c.params.worldWidth,worldHeight:T=c.params.worldHeight,...A}){const I={u_colors:i.map(Y),u_colorsCount:i.length,u_proportion:s,u_softness:o,u_distortion:n,u_swirl:a,u_swirlIterations:f,u_shapeScale:u,u_shape:N[l],u_scale:g,u_rotation:h,u_fit:C[p],u_offsetX:d,u_offsetY:z,u_originX:v,u_originY:x,u_worldWidth:y,u_worldHeight:T};return R.jsx(U,{...A,speed:e,frame:r,fragmentShader:G,uniforms:I})},Q);function oe(t){const e={speed:.4,rotation:.5,style:{width:"100%",height:"100%"}};return R.jsx(ee,{...e,...t,style:{...e.style,...t.style}})}export{oe as default};
